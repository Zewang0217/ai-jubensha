...
CREATE TABLE IF NOT EXISTS clues (
    ...
    type ENUM('PHYSICAL', 'DOCUMENT', 'MEDIA', 'OTHER') DEFAULT 'OTHER' COMMENT '线索类型',
    visibility ENUM('PUBLIC', 'DISCOVERED', 'PRIVATE', 'UNDISCOVERED') DEFAULT 'DISCOVERED' COMMENT '可见性',
...
-- 更新线索表的visibility字段，添加UNDISCOVERED值
ALTER TABLE clues MODIFY COLUMN visibility ENUM('PUBLIC', 'DISCOVERED', 'PRIVATE', 'UNDISCOVERED') DEFAULT 'DISCOVERED' COMMENT '可见性';
