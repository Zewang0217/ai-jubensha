...
const ScriptDetail = () => {
  ...
  const handleViewCharacters = () => {
    navigate(`/scripts/${id}/characters`)
  }
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-slate-50 pt-20">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-12">
            ...
            >
              <div className="relative aspect-[3/4] rounded-2xl overflow-hidden shadow-2xl shadow-blue-900/10">
                {/* 封面图片 */}
                <div
            ...
            >
              ...
              >
                ...
                <motion.button
                    ...
                    className="group inline-flex items-center justify-center gap-3 px-8 py-4 bg-gradient-to-r from-violet-500 to-violet-700 text-white text-lg font-semibold rounded-2xl shadow-xl shadow-violet-500/30 hover:shadow-2xl hover:shadow-violet-500/40 transition-all duration-300"
                >
                  <UsersRound className="w-6 h-6 group-hover:scale-110 transition-transform duration-300"/>
                  <span>角色详情</span>
                  <ChevronRight className="w-5 h-5 group-hover:translate-x-1 transition-transform duration-300"/>
                </motion.button>
